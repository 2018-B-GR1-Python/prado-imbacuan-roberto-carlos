# -*- coding: utf-8 -*-
"""
Created on Wed Nov 21 08:02:10 2018
...
directorio_a_leer = "C:\\Users\\rprado\\Downloads\\pandas-fundamentals\\02\\demos\\demos\\collection-master\\artworks"
    ...
    for path_raiz, lista_directorios, archivos in os.walk(directorio):
       for archivo in archivos:
           if archivo.endswith('json'):
               ...
               trabajo_arte_encontrados.append(registro_encontrado)
               break
    df = pd.DataFrame.from_records(trabajo_arte_encontrados, columns=llaves, index='id')
    return df
